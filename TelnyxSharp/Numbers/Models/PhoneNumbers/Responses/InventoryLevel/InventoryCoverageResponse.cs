...
namespace TelnyxSharp.Numbers.Models.PhoneNumbers.Responses.InventoryLevel
{
    /// <summary>
    /// Represents the response for an inventory coverage request.
    /// Inherits from <see cref="TelnyxResponse{TData}"/> to encapsulate the response data.
    /// </summary>
