...
namespace TelnyxSharp.Voice.Models.CallInformation.Responses
{
    /// <summary>
    /// Represents the response to a call information retrieval request.
    /// Inherits from <see cref="TelnyxResponse{TData}"/> with the data type being <see cref="RetrieveCallData"/>.
    /// </summary>
