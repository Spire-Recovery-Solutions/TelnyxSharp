...
/// <summary>
/// Represents an event indicating that the premium greeting detection has ended for a call.
/// This event contains a payload with details about the call and the result of the greeting detection.
/// </summary>
public class CallMachinePremiumGreetingEndedEvent : BaseEvent
{
    /// <summary>
    /// Gets or sets the payload of the premium greeting ended event.
    /// This payload contains various details regarding the call and detection results.
    /// </summary>
    [JsonPropertyName("payload")]
    public CallMachinePremiumGreetingEndedPayload Payload { get; set; }
}

/// <summary>
/// Represents the payload containing details of the premium greeting detection ended for a call.
/// This includes identifiers for call control, connection, call leg,
/// session, client state, and the detection result.
/// </summary>
public class CallMachinePremiumGreetingEndedPayload
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the result of the premium greeting detection.
    /// Possible values include: [beep_detected].
    /// </summary>
