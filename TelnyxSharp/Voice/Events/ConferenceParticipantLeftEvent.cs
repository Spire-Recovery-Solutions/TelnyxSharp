...
{
    /// <summary>
    /// Represents an event triggered when a participant leaves a conference.
    /// This event provides details about the participant leaving the conference.
    /// </summary>
    public class ConferenceParticipantLeftEvent : BaseEvent
    {
        /// <summary>
        /// Contains detailed information about the conference participant leaving event.
        /// </summary>
    ...
    /// <summary>
    /// Represents the payload data for a conference participant left event.
    /// </summary>
