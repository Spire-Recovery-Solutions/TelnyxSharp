...
/// <summary>
/// Represents an event indicating that the premium machine detection has ended for a call.
/// This event contains a payload with details about the call and the result of the machine detection.
/// </summary>
public class CallMachinePremiumDetectionEndedEvent : BaseEvent
{
    /// <summary>
    /// Gets or sets the payload of the premium machine detection ended event.
    /// This payload contains various details regarding the call and detection results.
    /// </summary>
    [JsonPropertyName("payload")]
    public CallMachinePremiumDetectionEndedPayload Payload { get; set; }
}

/// <summary>
/// Represents the payload containing details of the premium machine detection ended for a call.
...
public class CallMachinePremiumDetectionEndedPayload
{
    ...
    /// <summary>
    /// Gets or sets the result of the premium machine detection.
    /// Possible values include: [human_residence, human_business, machine, silence, fax_detected].
    /// </summary>
