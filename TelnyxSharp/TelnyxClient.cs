...
namespace TelnyxSharp;
    public class TelnyxClient : BaseOperations, ITelnyxClient
    {
        ...
        public TelnyxClient(string apiKey, string v1ApiToken = null)
        {
            ...
            {
                if (_v1Client == null)
                    throw new InvalidOperationException("v1 token not provided; Cdr Request Reports endpoints cannot be used.");
                return new CdrRequestsOperations(_v1Client, RateLimitRetryPolicy);
            }, LazyThreadSafetyMode.ExecutionAndPublication);
        }
