...
using TelnyxSharp.Messaging.Events;
using TelnyxSharp.Messaging.Models;
using TelnyxSharp.Messaging.Models.AdvancedOptInOptOut;
...
using TelnyxSharp.Messaging.Models.Brands;
...
using TelnyxSharp.Messaging.Models.Campaign.Requests;
using TelnyxSharp.Messaging.Models.Campaign.Responses;
...
using TelnyxSharp.Messaging.Models.NumberConfigurations.Requests;
using TelnyxSharp.Messaging.Models.NumberConfigurations.Responses;
...
using TelnyxSharp.Messaging.Models.SharedCampaign;
...
using TelnyxSharp.Messaging.Models.TollFreeVerificationOperations;
...
using TelnyxSharp.Numbers.Models.ChannelZones.Requests;
using TelnyxSharp.Numbers.Models.ChannelZones.Responses;
...
using TelnyxSharp.Numbers.Models.PhoneNumbers.Requests.BulkPhoneNumberOperations;
...
using TelnyxSharp.Numbers.Models.PhoneNumbers.Responses;
using TelnyxSharp.Numbers.Models.PhoneNumbers.Responses.AdvancedNumberOrders;
using TelnyxSharp.Numbers.Models.PhoneNumbers.Responses.BulkPhoneNumberOperations;
...
using TelnyxSharp.Voice.Models.CallControlApplications;
...
using TelnyxSharp.Voice.Models.ConferenceCommands;
...
namespace TelnyxSharp
{
    ...
    [JsonSerializable(typeof(BaseNumberOrderData))]
    [JsonSerializable(typeof(NumberOrderListData))]
    [JsonSerializable(typeof(NumberOrderDetailData))]
    [JsonSerializable(typeof(NumberOrderPhoneNumber))]
    [JsonSerializable(typeof(NumberOrderPhoneNumberDetail))]
