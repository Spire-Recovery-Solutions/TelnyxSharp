...
/// <summary>
/// Represents an event indicating that machine detection has ended for a call.
/// This event contains a payload with details about the call and the result of the machine detection.
/// </summary>
public class CallMachineDetectionEndedEvent : BaseEvent
{
    /// <summary>
    /// Gets or sets the payload of the machine detection ended event.
    /// This payload contains various details regarding the call and detection results.
    /// </summary>
    [JsonPropertyName("payload")]
    public CallMachineDetectionEndedPayload Payload { get; set; }
}

/// <summary>
/// Represents the payload containing details of the machine detection ended for a call.
...
public class CallMachineDetectionEndedPayload
{
    ...
    /// <summary>
    /// Gets or sets the result of the machine detection.
    /// Possible values include: [human, machine, not_sure].
    /// </summary>
