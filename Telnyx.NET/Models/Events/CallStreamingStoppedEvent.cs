...
/// <summary>
/// Represents an event indicating that call streaming has stopped.
/// This event contains a payload with details about the call and the streaming information.
/// </summary>
public class CallStreamingStoppedEvent : BaseEvent
{
    /// <summary>
    /// Gets or sets the payload of the call streaming stopped event.
    /// This payload contains various details regarding the call and streaming details.
    /// </summary>
    [JsonPropertyName("payload")]
    public CallStreamingStoppedPayload Payload { get; set; }
}

/// <summary>
/// Represents the payload containing details of the stopped call streaming.
/// This includes identifiers for call control, connection, call leg,
/// session, client state, and the stream URL.
/// </summary>
public class CallStreamingStoppedPayload
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the destination WebSocket address where the stream was delivered.
    /// </summary>
