...
{
    /// <summary>
    /// Represents the Call AI Gather Partial Results event received from Telnyx.
    /// </summary>
    public class CallAiGatherPartialResultsEvent : BaseEvent
    {
        /// <summary>
        /// Gets or sets the payload specific to the Call AI Gather Partial Results event.
        /// </summary>
        [JsonPropertyName("payload")]
        public new AiGatherPartialResultsPayload Payload { get; set; }
    }

    /// <summary>
    /// Represents the payload for the Call AI Gather Partial Results event.
    /// </summary>
    public class AiGatherPartialResultsPayload
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the history of the messages exchanged during the AI gather process.
        /// </summary>
        [JsonPropertyName("message_history")]
        public MessageHistory[] MessageHistory { get; set; }

        /// <summary>
        /// Gets or sets the partial results of the AI gather process.
        /// </summary>
