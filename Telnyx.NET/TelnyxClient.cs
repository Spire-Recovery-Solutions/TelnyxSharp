...
namespace Telnyx.NET
{
    public class TelnyxClient : ITelnyxClient, IDisposable
    {
        ...
        public async Task<CreateMessagingProfileResponse?> CreateMessagingProfile(CreateMessagingProfileRequest request, CancellationToken cancellationToken = default)
        {
            ...
            return await _policies[typeof(CreateMessagingProfileRequest)].ExecuteAsync(token => ExecuteAsync<CreateMessagingProfileResponse>(req, token), cancellationToken);
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return await _policies[typeof(MessagingProfilePhoneNumberRequest)].ExecuteAsync(
